...
public class TestProController {
	...
	public void testNoticeList() throws  Exception{
		log.info(mockMvc.perform(MockMvcRequestBuilders.post("/animalConnect/member/proJoin")
		.param("nicName","gold77")
		.param("proCheck", "NO")
		.param("proName", "홍길동77")
		.param("proEmail", "gold77@naver.com")
		.param("proPw", "123123")
		.param("proHp", "010-1111-1111"))
		.andReturn()
		.getModelAndView()
		.getViewName());
	}
